...
public record LaLToolMaterial(TagKey<Block> incorrectBlocksForDrops, int durability, float speed, float attackDamageBonus, int enchantmentValue, TagKey<Item> repairItems) {
    ...
    public static final ToolMaterial VERDANT = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, 284, 4.0F, 1.0F, 10,LaLItemTags.VERDANT_TOOL_MATERIALS);
    public static final ToolMaterial CLEAVING = new ToolMaterial(BlockTags.INCORRECT_FOR_IRON_TOOL, 332, 6.0F, 2.0F, 12, LaLItemTags.CLEAVING_TOOL_MATERIALS);
