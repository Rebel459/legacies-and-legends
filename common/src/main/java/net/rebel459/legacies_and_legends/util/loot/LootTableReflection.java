...
final class LootTableReflection {
    ...
    private LootTableReflection() {}

    @SuppressWarnings("unchecked")
    static List<LootPoolEntryContainer> getEntries(LootPool.Builder pool) {
        try {
    ...
    static void setEntries(LootPool.Builder pool, List<LootPoolEntryContainer> entries) {
        try {
    ...
    static void setConditions(LootPool.Builder pool, List<LootItemCondition> conditions) {
        try {
    ...
    static void setFunctions(LootPool.Builder pool, List<LootItemFunction> functions) {
        try {
    ...
    static void setRolls(LootPool.Builder pool, NumberProvider rolls) {
        try {
    ...
    static void setBonusRolls(LootPool.Builder pool, NumberProvider bonusRolls) {
        try {
    ...
    static Object getItem(LootPoolEntryContainer entry) {
    ...
    @SuppressWarnings("unchecked")
    static List<LootPool> getPools(LootTable table) {
        try {
    ...
    @SuppressWarnings("unchecked")
    static List<LootItemFunction> getFunctions(LootTable table) {
        try {
    ...
    @SuppressWarnings("unchecked")
    static Optional<Identifier> getRandomSequence(LootTable table) {
        try {
    ...
    static void setFunctions(LootTable.Builder table, List<LootItemFunction> functions) {
        try {
    ...
    @SuppressWarnings("unchecked")
    static List<LootPoolEntryContainer> getEntries(LootPool pool) {
        try {
    ...
    @SuppressWarnings("unchecked")
    static List<LootItemCondition> getConditions(LootPool pool) {
        try {
    ...
    @SuppressWarnings("unchecked")
    static List<LootItemFunction> getFunctions(LootPool pool) {
        try {
    ...
    static NumberProvider getRolls(LootPool pool) {
        try {
    ...
    static NumberProvider getBonusRolls(LootPool pool) {
        try {
