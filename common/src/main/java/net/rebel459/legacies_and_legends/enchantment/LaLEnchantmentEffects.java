...
public class LaLEnchantmentEffects {
    ...
    public static UnifiedRegistries.DeferredRegistry ENTITY_EFFECTS = UnifiedRegistries.DeferredRegistry.create(LaLConstants.MOD_ID, BuiltInRegistries.ENCHANTMENT_ENTITY_EFFECT_TYPE);
    public static UnifiedRegistries.DeferredRegistry LOCATION_EFFECTS = UnifiedRegistries.DeferredRegistry.create(LaLConstants.MOD_ID, BuiltInRegistries.ENCHANTMENT_LOCATION_BASED_EFFECT_TYPE);
